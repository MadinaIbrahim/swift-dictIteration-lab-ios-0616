 ...
 */
var bandWithAlbumDictionary = ["Nirvana" : "Nevermind",
 ...
 */
bandWithAlbumDictionary["Pixies"] = "Doolittle"
print("\(bandWithAlbumDictionary)")
/*: question3
 ### 3. We don't care that much about The Kinks. Delete them from the dictionary you created in Question 1.
 */
bandWithAlbumDictionary.removeValueForKey("The Kinks")
print("\(bandWithAlbumDictionary)")
...
if let topSellingAlbum = bandWithAlbumDictionary[bandName] {
 ...
 */
for (band, topSellingAlbum) in bandWithAlbumDictionary {
    print("\(band)'s top-selling album was \(topSellingAlbum).")
}
/*: question6
 ### 6. What type of data structure is returned when you iterate over a dictionary?
 */
// A tuple with keys and values  type of String, are returned as a result iterating over a dictionary.
/*: question7
 ...
 */
// We could create a dictionary that maps every grade in the high school as a keys (with Int data types for each grade) to their values as a String data types for letter grade.
...
for (grade, score) in gradeLetters {
